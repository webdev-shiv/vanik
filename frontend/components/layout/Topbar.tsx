  ...
  return (
    <header className="h-16 bg-white border-b border-navy-200/80 px-4 md:px-6 flex items-center justify-between sticky top-0 z-30 select-none shadow-xs">
      ...
      <div className="flex items-center gap-2.5">
        ...
        {/* Merchant User Avatar Pill */}
        <div className="flex items-center gap-2.5 pl-2 border-l border-navy-200/80">
          ...
          <div className="hidden sm:block text-left">
            <div className="text-xs font-extrabold text-navy-900 leading-none">{merchantInfo.name}</div>
